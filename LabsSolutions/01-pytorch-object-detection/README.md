...
In the following, I suppose the dataset Pascal VOC2012 has been saved into **/mounts/Datasets4/Pascal-VOC2012/**
...
You can tweak the number of workers, below I use 7. 
    ...
    python3 extract_features.py  --use_gpu --model resnet152 --target_mode largest_bbox --image_mode shrink --output_dir /tmp/tensors-single --dataset_dir /mounts/Datasets4/Pascal-VOC2012/ --num_workers 7
...
You can tweak the number of workers, below I use 7. 
    ...
    python3 extract_features.py  --use_gpu --model resnet152 --target_mode all_bbox --image_mode shrink --output_dir /tmp/tensors-multi --dataset_dir /mounts/Datasets4/Pascal-VOC2012/ --num_workers 7
