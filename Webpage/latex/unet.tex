...
%%%%%%%%%%
% Block 1
\pic[shift={(0,0,0)}] at (0, 0, 0) {RightBandedBox={name=cr2,%
        xlabel={{"",""}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=32,width={1,1},depth=32}};
% pool
...
\pic[shift={(0,0,0)}] at (cr3-east) {Box={name=p3,%
        fill=\PoolColor,opacity=0.5,height=16,width=2,depth=16}};
%%%%%%%%%%
% Block 3
\pic[shift={(0.5,0,0)}] at (p3-east) {RightBandedBox={name=cr4,%
        xlabel={{"",""}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=16,width={4,4},depth=16}};
% pool
\pic[shift={(0,0,0)}] at (cr4-east) {Box={name=p4,%
        fill=\PoolColor,opacity=0.5,height=8,width=4,depth=8}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Bottleneck
...
\pic[shift={(1.2,0,0)}] at (cr5-east) {Box={name=up4,%
        fill=\UnpoolColor,opacity=0.6,height=16,width=8,depth=16}};
\pic[shift={(0.6,0,0)}] at (up4-east) {RightBandedBox={name=ucr4,%
        xlabel={{"","dummy"}},fill=\ConvReluColor,bandfill=\ConvReluColor,
        height=16,width=4,depth=16}};
\pic[shift={(0,0,0)}] at (ucr4-east) {Box={name=cat4,%
        fill=\ConvReluColor,opacity=0.7,height=16,width=4,depth=16}};    
\pic[shift={(0.6,0,0)}] at (cat4-east) {RightBandedBox={name=ucr4a,%
        xlabel={{"",""}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=16,width={4,4},depth=16}};
%%%%%%%%%%
%% unpool3, 
\pic[shift={(1.2,0,0)}] at (ucr4a-east) {Box={name=up3,%
        fill=\UnpoolColor,opacity=0.6,height=25,width=4,depth=25}};
\pic[shift={(0.6,0,0)}] at (up3-east) {RightBandedBox={name=ucr3,%
        xlabel={{"","dummy"}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=25,width=2,depth=25}};
\pic[shift={(0,0,0)}] at (ucr3-east) {Box={name=cat3,%
        xlabel={{"",""}},fill=\ConvReluColor,opacity=0.7,height=25,width=2,depth=25}};
\pic[shift={(0.6,0,0)}] at (cat3-east) {RightBandedBox={name=ucr3a,%
        xlabel={{"",""}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=25,width={2,2},depth=25}};
%%%%%%%%%%
%% unpool2, 
\pic[shift={(1.2,0,0)}] at (ucr3a-east) {Box={name=up2,%
        fill=\UnpoolColor,opacity=0.6,height=32,width=2,depth=32}};
\pic[shift={(0.6,0,0)}] at (up2-east) {RightBandedBox={name=ucr2,%
        xlabel={{"","dummy"}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=32,width=1,depth=32}};
\pic[shift={(0,0,0)}] at (ucr2-east) {Box={name=cat2,%
        xlabel={{"",""}},fill=\ConvReluColor,opacity=0.7,height=32,width=1,depth=32}};    
\pic[shift={(0.6,0,0)}] at (cat2-east) {RightBandedBox={name=ucr2a,%
        xlabel={{"",""}},fill=\ConvColor,bandfill=\ConvReluColor,%
        height=32,width={1, 1},depth=32}};
%%%%%%%%%%
%% unpool1, 
...
%        xlabel={{"64",""}},fill={rgb:white,1;black,3},bandfill={rgb:whit%e,1;black,2},opacity=0.2,height=40,width=2.5,depth=40}};  
...
%% Classifier 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pic[shift={(0.75,0,0)}] at (ucr2a-east) {Box={name=out,%caption=Output,%
        ,fill=\SoftmaxColor,height=32,width=0.5,depth=32}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Draw connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\draw [connection]  (ucr2a-east) -- node {\midarrow} (out-west);
