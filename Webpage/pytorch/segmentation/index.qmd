...
![Cross entropy loss vs focal loss. The focal loss attenuates more quickly than the cross entropy loss the influence of correctly predicted pixels. Generated using [focal.py](focal.py)](focal.png){width=70%}
