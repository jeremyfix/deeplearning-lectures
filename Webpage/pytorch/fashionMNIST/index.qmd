...
See https://ia2vr.gitlabpages.inria.fr/iliar/pytorch_introduction.html
...
![Training accuracy for logistic regression without normalization of the input](./linear_train_acc.png){width=40%}

![Validation accuracy for logistic regression without normalization of the input](./linear_val_acc.png){width=40%}
...
![Metrics on the training set for the fully connected model](./fc_train_metrics.png){width="75%"}

![Metrics on the validation set for the fully connected model](./fc_val_metrics.png){width="75%"}
...
![Metrics on the training set when adding L2 regularization](./fc_l2reg10m3_train_metrics.png){width="75%"}

![Metrics on the validation set when adding L2 regularization](./fc_l2reg10m3_val_metrics.png){width="75%"}
...
![Metrics on the training set when adding dropout 0.2](./fc_dropout0_2_train_metrics.png){width="75%"}

![Metrics on the validation set when adding dropout of 0.2](./fc_dropout0_2_val_metrics.png){width="75%"}
...
![Some variations of the pullover do not change the class of the image](./fashionMNIST_sample_augment.png){width="100%"}

And the same applies for other classes as well :

![The same transformations as before applied to several classes](./fashionMNIST_samples_augment.png){width="100%"}
...
![This is not hulk, R. Magritte](./hulk-0.png){width="15%"}

![This is still not hulk, R. Magritte](./hulk-1.png){width="15%"}

![This is still not hulk again, R. Magritte](./hulk-2.png){width="15%"}
