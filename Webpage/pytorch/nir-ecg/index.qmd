...
- [@mueller2022instant] who introduced Instant NGP mainly a NERF with a better encoding of the input coordinates and led to the development of tiny-cuda-nn, a highly optimized implementation of NERFs,
...
``` bash
(venv) mymachine:~:mylogin$ python -m pip install -e nir
```
...
![The NERF encodes the scene and is optimised by computing the loss between the expected camera projections and the actual observations](https://cdn.prod.website-files.com/51e0d73d83d06baa7a00000f/5e700ef6067b43821ed52768_pipeline_website-01-p-800.png)
...
**Exercise** Modify your configuration file to use the multiresolution hash encoding. You can for example consider the parameters below. For the FFFN, as explained in the paper [@mueller2022instant], a much smaller network can be considered. 
